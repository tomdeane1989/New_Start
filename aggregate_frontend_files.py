...
# Output file name
output_file = "frontend_aggregated.txt"

def aggregate_files(file_paths, output_file):
    """
    Aggregates the contents of all frontend files into a single output file.
...
if __name__ == "__main__":
    aggregate_files(frontend_file_paths, output_file)